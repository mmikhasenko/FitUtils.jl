# #######################################################################
# Minuit MWE
# o = FitUtils.iminuit.Minuit(x->x[1]^2+x[2]^2, [1.0, 1.0])
# o.errordef = 1/2
# migrad_result = FitUtils.pycall(o.migrad, FitUtils.PyObject)
# hesse_result = FitUtils.pycall(o.hesse, FitUtils.PyObject)
# 
# migrad_result.fmin
...
isiminuitimported() = (FitUtils.iminuit != FitUtils.PyNULL())
...
function obj2nt(obj::PyObject)
    if string(obj.__class__) == str_class_Minuit
        fmin = obj2nt(obj.fmin, FitUtils.keys_FMin)
